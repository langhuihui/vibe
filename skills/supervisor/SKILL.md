...
3. 调用 `产品总监` Agent 审批PRD
4. 调用 `技术总监` Agent 设计技术方案
5. 调用 `技术骨干` Agent 进行详细设计
6. 汇总设计成果，请求人类确认
7. 人类确认后进入开发阶段
...
3. Agent输出需更新到对应文档
4. 检查文档确认任务完成
5. **任何需要执行的工作都必须通过Agent完成，禁止亲自动手**
6. **调研工作由产品经理（业务调研）或技术骨干（技术调研）执行**
