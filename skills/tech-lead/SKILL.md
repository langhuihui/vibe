...
| 踩坑经验库 | `.vibe/docs/踩坑经验库.md` | 历史经验参考 |
| 常见问题检查清单 | `.vibe/docs/常见问题检查清单.md` | 高频问题速查 |
...
| 踩坑经验记录 | `.vibe/docs/踩坑经验记录.md` | **新增经验** |
| 踩坑经验库 | `.vibe/docs/踩坑经验库.md` | **更新经验库** |
...
- **项目内副本**：`.vibe/docs/常见问题检查清单.md`（由技术骨干在发现新高频问题时更新，供本迭代速查）
